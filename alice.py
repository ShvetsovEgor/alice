...
app = Flask(__name__)
# run_with_ngrok(app)git remote add origin https://github.com/ShvetsovEgor/alice.git
 # git branch -M main
...
def handle_dialog(req, res):
    ...
    t = req['request']['original_utterance'].lower()
    if any([x in t for x in ['ладно', 'куплю', 'покупаю', 'хорошо']]):
